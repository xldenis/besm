...
options =
  simpleOptions "v0.1.0" "PP-BESM Compiler Source Code and Debugger" "" (pure ()) $ do
    addCommand
      ...
      compileCommand
      ((,) <$> outputFileArg <*> optional sourceMapArg)
    addCommand
      "trace"
      "visualize a trace file generated by the BESM VM"
      traceCommand
      ((,,) <$> fileArg <*> outputFileArg <*> sourceMapArg)
    addCommand
      "cfg"
...
traceCommand (inFile, oFile, smFile) = do
  visualizeTrace inFile oFile smFile
